        ...
        @foreach($customers as $customer)
            <div class="mt-8 dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <h2 class="@if($customer->CustomerStatusId=='RE') dark:text-red @else dark:text-white @endif">{{$customer->Name}}</h2>
                    ...
                    <h5 class="text-gray-900 dark:text-white">{{$customer->CustomerStatusId}}</h5>
